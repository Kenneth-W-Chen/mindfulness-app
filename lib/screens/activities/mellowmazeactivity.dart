...
// initialize to full concentration
_resetHealthBar();
}
...
/// Helper to reset the health bar tween back to 100%.
...
// jump the controller to the end so value == 1.0 immediately
_healthController.value = 1.0;
}
...
_textController.forward();
_resetHealthBar();  // restore health bar to full
});
});
}
...
'Mellow Maze Adventure', Colors.teal[800]!, context, _minigamePlayed),
